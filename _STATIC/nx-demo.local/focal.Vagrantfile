...
Vagrant.configure("2") do |config|
    ...
    config.vm.define HOST_ADDR do |machine|
      ...
      machine.vm.provision "shell", path: "../../_shell/system/multipath_daemon.sh", run: "once"

      # delete default gw on eth0
      # machine.vm.provision "shell", run: "always", inline: "sudo ip route del 0/0"
      machine.vm.provision "shell", path: "../../_shell/system/route.sh"

      # Host Record Updates
      machine.vm.provision "shell", path: "../../_shell/system/hosts.sh"
      ...
      machine.vm.provision "shell", path: "../../_shell/soft/docker_config_nexus.sh"

      # Install Ansible
      machine.vm.provision "shell", path: "../../_shell/soft/ansible.sh"

      # Install Kubernetes Utils
      machine.vm.provision "shell", path: "../../_shell/soft/kubernetes.sh"

      # Install Helm
      machine.vm.provision "shell", path: "../../_shell/soft/helm.sh"

      # CertBot Let’s Encrypt
      machine.vm.provision "shell", path: "../../_shell/soft/certbot.sh"
