...
# ---------------------------------
MAC_ADDR = "080027ABC172"
IP_ADDR = "192.168.1.172"      #  Bridge
IP_LOCL = "192.168.50.72"      #  Internal
IP_HOST = "192.168.56.72"      #  Host-Only
# ---------------------------------
HOST_ADDR = "nx-manager-mayki.local"
VM_GROUP = "/local"
VM_DESCR = "
...
Vagrant.configure("2") do |config|
    ...
    config.vm.define HOST_ADDR do |machine|
      ...
      # machine.vm.provision "shell" do |kuberinit|
      #   kuberinit.inline = "
      ...
      #     "
      #   kuberinit.args  = [KUBERNETES_VERSION]
      # end
      ...
      # machine.vm.provision "shell", inline: "
      # sudo rsync -arctuxz --remove-source-files /tmp/home/  /home/ubuntu/
      # sudo chown -R ubuntu:ubuntu /home/ubuntu/
      # sudo rm -rf /tmp/home/
      # "

      # Geographic Location
      # https://linuxways.net/ubuntu/how-to-find-linux-server-geographic-location-in-terminal/
      # curl https://ipinfo.io/ip
      # curl ifconfig.me
      # sudo apt install geoip-bin
      # geoiplookup <IP-address>
      # geoiplookup $(curl -s https://ipinfo.io/ip)
      # curl -s https://ipvigilante.com/$(curl -s https://ipinfo.io/ip) | jq '.data.latitude, .data.longitude, .data.city_name, .data.country_name'

      machine.vm.provision "shell", inline: "
      echo \"Installing L2TP\"
      sudo apt-get install -yq network-manager-l2tp resolvconf
      "

      machine.vm.provision "shell", inline: "
      sudo nmcli connection add connection.id trusi con-name trusi type VPN vpn-type l2tp ifname -- \
      connection.autoconnect no ipv4.method auto vpn.data \"gateway = vpn.trusi.ru, \
      ipsec-enabled = yes, mru = 1400, mtu = 1400, \
      password-flags = 0, refuse-chap = yes, refuse-mschap = yes, refuse-pap = yes, \
      require-mppe = yes, user = userman \" vpn.secrets \"password=PASSWORD, ipsec-psk = trusi\"
      "
