...
Vagrant.configure("2") do |config|
    ...
    config.vm.define "bionic64" do |machine|
      machine.vm.hostname = "bionic64"

      machine.vm.provider "virtualbox" do |vbox|
        # https://www.virtualbox.org/manual/ch08.html        
        vbox.customize ["modifyvm", :id, "--name", "bionic64"]
      ...
      # machine.vm.network "public_network", bridge: "Intel7260", :ipv6 => false    # WiFi
      machine.vm.network "public_network", bridge: 'Hyper-V Virtual Ethernet Adapter #2'
      ...
      machine.vm.synced_folder "D:\\Addreality_Single", "/addreality", 
        # disabled: false
        disabled: false,
        # id: "ansible-project",
        # owner: ADMIN_LOGIN,
      ...
      sudo apt-get install -y htop iotop mc nano
      "
