...
Vagrant.configure("2") do |config|
    ...
    config.vm.define "minikube" do |machine|
      ...
      machine.vm.provider "virtualbox" do |vbox|
        ...
        vbox.customize ["modifyvm", :id, "--memory", "5120"]        
      ...
      # minikube start --kubernetes-version v1.18.0 --driver=hyperv --cpus=4 --memory='5g' --disk-size='20000mb'
      # minikube status
      ...
      # microk8s enable istio ingress rbac hostpath-storage
      # microk8s status
